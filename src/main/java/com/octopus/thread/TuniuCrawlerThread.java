package com.octopus.thread;//package com.octopus.thread;
//
//import com.octopus.jobHandler.TuniuCrawler;
...
//@NoArgsConstructor
//@Service
//public class TuniuCrawlerThread extends Thread {
//
//    private String url;
//    @Autowired
...
//
//    public TuniuCrawlerThread(String url) {
//        this.url = url;
//    }
//
//    @Override
...
//                line.setSupplier(getSupplier(detailElements.get(i)));
...
//                }
//                //log.warn(soldNum);
//                line.setSoldqty(soldQty);
//                line.setCommentNumber(getCommentNum(priceElements.get(i)));
//                line.setScenic(getScenic(detailElements.get(i)));
//                line.setDurl(getDurl(detailElements.get(i)));
//                Document detailDoc;
//                try {
//                    detailDoc = Jsoup.connect(line.getDurl())
//                            .header("Accept", "*/*")
//                            .header("Accept-Encoding", "gzip, deflate")
//                            .header("Accept-Language", "zh-CN,zh;q=0.8,en-US;q=0.5,en;q=0.3")
//                            .header("Referer", "https://www.baidu.com/")
...
//                line.setTraffic(getTravel(summaryElements));
...
//                try {
//                    String lineNo = line.getDurl().substring(line.getDurl().lastIndexOf("/") + 1, line.getDurl().length());
